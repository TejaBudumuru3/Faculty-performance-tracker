...
<html lang="en">
<head>
    <title>Departmental Faculty Reports</title>
...
<body>
    ...
    <!-- Main Content -->
    <div class="main">
        <h1>Generate Faculty Reports</h1>
                                ...
                                if (con == null) {
                                    ...
                                    if(roleId!=3){
                                        ...
                                        //Query for Faculty list
                                            String sql = "SELECT FacultyID, FacultyName FROM faculty where DepartmentID = ? and staffid = 1";
                    ...
                    try {
                        ...
                        if (faculty != null && year != null && month != null && week != null) {
                            if(Integer.parseInt(week) == 1){
                                ...
                                // SQL query
                                String ReportQuery = "SELECT SUM(l.ClassHours + l.PreparationTime + l.ProjectReview + l.CounsellingHours) AS GenericWork, " +
                                                    "SUM(l.InvigilationHours + l.ExamEvaluations + l.Viva + l.Externals) AS Examination, " +
                                                    "SUM(l.Meetings + l.Seminars + l.Workshops + l.EventHours) AS Membership, " +
                                                    "SUM(l.PublicationResearchWork + l.PatentResearchWork) AS Publications, " +
                                                    "SUM(l.PublicationsPublished) AS PublicationsPublished, " +
                                                    "SUM(l.PatentsGained) AS PatentsGained " +
                                                    "FROM FACULTY f LEFT JOIN log l ON f.facultyid = l.facultyid " +
                                                    "WHERE f.facultyid = ? AND YEAR(l.Date) = ? AND MONTH(l.Date) = ? AND DAY(l.Date) BETWEEN ? AND ?";
                                ...
                                while (reportRs.next()) {
                                    ...
                                    if (!isgenericWorkNull && !isexaminationNull && !ismembershipNull && !ispublicationsNull && !ispublicationsPublishedNull && !ispatentsGainedNull) {
                                        ...
                                        out.println("<p style='font-size:20px'>Report for Faculty ID: " + faculty + " between <strong>"+date+"</strong></p>");
